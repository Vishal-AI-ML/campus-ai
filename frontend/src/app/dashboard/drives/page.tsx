		...
		<div>
			...
			{showForm && (
				...
				>
					<div className="grid gap-4 sm:grid-cols-2">
						<div>
							<label className="text-sm text-slate-600 dark:text-slate-300">Company *</label>
							<input
								required
						...
						<div>
							<label className="text-sm text-slate-600 dark:text-slate-300">Package (LPA)</label>
							<input
								type="number"
								step="0.1"
						...
						<div>
							<label className="text-sm text-slate-600 dark:text-slate-300">Min CGPA</label>
							<input
								type="number"
								step="0.1"
								value={form.min_cgpa}
						...
						<div>
							<label className="text-sm text-slate-600 dark:text-slate-300">Min attendance %</label>
							<input
								type="number"
								step="1"
						...
						<div>
							<label className="text-sm text-slate-600 dark:text-slate-300">Min verified projects</label>
							<input
								type="number"
								step="1"
						...
						<div>
							<label className="text-sm text-slate-600 dark:text-slate-300">Deadline</label>
							<input
								type="date"
								value={form.deadline}
			...
			<div className="mt-8">
				{loading ? (
					...
					<p className="text-slate-500 dark:text-slate-400">No drives yet. Post your first one.</p>
				) : (
								...
								<div className="flex flex-wrap items-start justify-between gap-3">
									...
									<div className="flex gap-2">
										<button
											...
											className="rounded-lg border border-slate-300 dark:border-white/15 px-3 py-1.5 text-sm transition hover:bg-slate-100 dark:hover:bg-white/10"
										>
											{drive.is_open ? "Close" : "Open"}
										</button>
										<Link
											href={`/dashboard/drives/${drive.id}`}
											className="rounded-lg bg-slate-100 dark:bg-slate-800 px-3 py-1.5 text-sm transition hover:bg-white/15"
										>
