...
// Department -> Section picker for the Doubt Forum (teacher side).
// Self-contained copy; reads /admin/departments + /admin/departments/{id}/sections
// (both readable by any logged-in user) and reports the chosen section up.

import { useEffect, useState } from "react"
import { api, ApiError } from "@/lib/api"
import type { Department, Section } from "./doubtsApi"
